...
- Abra PRs na branch `dev` e acompanhe as guidelines do projeto
- Escreva testes para novas features e atualize as migrations conforme necessário

## Contato

Para dúvidas sobre o backend, adicione uma issue ou entre em contato com os mantenedores do repositório.

---

README gerado / atualizado para desenvolvedores: descreve estrutura, como executar, variáveis importantes e troubleshooting.
